...
if(isset($_POST['fname']) && isset($_POST['lname']) && isset($_POST['Phone']) && isset($_POST['birth']) && isset($_POST['week']) && isset($_POST['area'])) {
    ...
    try {
        ...
        $qrystr = " INSERT INTO `rosia` (`fname`, `Lname`, `phone number`, `Birthday`, `time`, `Notes`, `program`) VALUES ('".$fname."', '".$lname."', '".$phone."', '". $birth."', '". $week."', '". $comm."', 'first program');
 ";
...
<div>
    ...
    <form action="rin.php" method="post">
...
<div class="img">
    <a href="ticket.html"> <img src="ss.jpg"  width="100px" height="100px"> </a>
