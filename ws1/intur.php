...
if(isset($_POST['fname']) && isset($_POST['lname']) && isset($_POST['Phone']) && isset($_POST['birth']) && isset($_POST['week']) && isset($_POST['area'])) {
    ...
    try {
        ...
        $qrystr = " INSERT INTO `Turkia` (`fname`, `Lname`, `phone number`, `Birthday`, `time`, `Notes`, `program`) VALUES ('".$fname."', '".$lname."', '".$phone."', '". $birth."', '". $week."', '". $comm."', 'third program');
 ";
...
<div>
    ...
    <form action="intur.php" method="post">
...
<div class="img">
    <a href="ticindia.html"> <img src="ss.jpg"  width="100px" height="100px"> </a>
