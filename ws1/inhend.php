...
if(isset($_POST['fname']) && isset($_POST['lname']) && isset($_POST['Phone']) && isset($_POST['birth']) && isset($_POST['week']) && isset($_POST['area'])) {
    ...
    try {
        ...
        $qrystr = " INSERT INTO `india` (`fname`, `Lname`, `phone number`, `Birthday`, `time`, `Notes`, `program`) VALUES ('".$fname."', '".$lname."', '".$phone."', '". $birth."', '". $week."', '". $comm."', 'third program');
 ";
...
<div>
    ...
    <form action="inhend.php" method="post">
